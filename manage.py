#!/usr/bin/env python
""" Main entry point into the "Reference Research App" Flask application.
...
def parse_options():
    ...
    if OPTIONS['--config_prod']:
        config_class_string = 'researchapp.config.Production'
    else:
        config_class_string = 'researchapp.config.Config'
